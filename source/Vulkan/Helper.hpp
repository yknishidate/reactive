...
namespace Helper
{
    inline VKAPI_ATTR VkBool32 VKAPI_CALL DebugMessage(VkDebugUtilsMessageSeverityFlagBitsEXT messageSeverity,
    ...
    inline vk::UniqueInstance CreateInstance(const std::vector<const char*>& extensions,
    ...
    inline uint32_t FindQueueFamily(vk::PhysicalDevice physicalDevice, vk::SurfaceKHR surface)
    {
    ...
    inline vk::UniqueDevice CreateDevice(vk::PhysicalDevice physicalDevice, uint32_t queueFamily)
    {
    ...
    inline vk::UniqueCommandPool CreateCommandPool(vk::Device device, uint32_t queueFamily)
    {
    ...
    inline vk::UniqueDescriptorPool CraeteDescriptorPool(vk::Device device)
    {
    ...
    inline vk::UniqueSwapchainKHR CreateSwapchain(vk::Device device, vk::SurfaceKHR surface, uint32_t minImageCount, uint32_t queueFamily)
    {
    ...
    inline std::vector<vk::UniqueImageView> CreateImageViews(vk::Device device, const std::vector<vk::Image>& images)
    {
    ...
    inline vk::UniqueRenderPass CreateRenderPass(vk::Device device)
    {
