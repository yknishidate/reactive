...
//     Context::getDevice().getBufferMemoryRequirements(*buffer); uint32_t memoryTypeIndex =
//     Context::findMemoryTypeIndex(requirements, memoryProp); vk::MemoryAllocateFlagsInfo
//     flagsInfo{vk::MemoryAllocateFlagBits::eDeviceAddress}; memory =
